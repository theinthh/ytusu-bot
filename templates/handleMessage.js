...
module.exports = function handleMessage(sender_psid, received_message) {
  ...
  received_message.text === "Get Started"
    ...
    ? (response = {
        text:
          'You can start the conversation with the bot by typing "Get Started" .Or wait for the admin to reply.',
      })
    ...
    : (response = {
        text: "If you have any question, the admin will reply soon.",
      });
